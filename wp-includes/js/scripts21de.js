      ...
      places.forEach((place) => {
        ...
        if (place.geometry.viewport) {
		 ...
		 console.log(firstValuetoLower);
		  ...
		  var array = ['cyprus', 'belgium', 'czech republic', 'denmark', 'estonia', 'finland', 'france', 'germany', 'greece', 'ireland', 'poland', 'croatia', 'hungary', 'iceland', 'latvia', 'lithuania', 'netherlands', 'norway', 'slovakia', 'sweden', 'switzerland', 'canada', 'usa', 'united states', 'united-arab-emirates', 'india', 'jordan', 'singapore', 'kypros', 'philippines', 'australia', 'columbia', 'panama', 'costa rica', 'hondurus', 'el salvador', 'guatemala', 'eesti', 'belgië', 'česká republika', 'danmark', 'portugal', 'spain', 'suomi', 'deutschland', 'hellas', 'Ελλάς', 'magyarország', 'ísland', 'latvija', 'lietuva', 'united arab emirates', 'nederlân', 'oman', 'malta', 'chile', 'vietnam', 'romania', 'bulgaria', 'serbia', 'thailand', 'indonesio', 'saudi arabia', 'norge', 'austria', 'österreich', 'sverige', 'slovensko', 'schweiz', 'mexico', 'mehhiko', 'israel', 'india', 'united kingdom', 'uk', 'south korea', 'egypt', 'colombia', 'honduras', 'kreeka', 'sveits', 'taani', 'jordaania', 'araabia-ühend-emiraadid', 'kanada', 'prantsusmaa']
